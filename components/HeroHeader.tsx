...
export default function HeroHeader({ heroData }: HeroHeaderProps) {
  return (
    <section className="relative w-full bg-gradient-to-br from-[var(--color-forest)] to-[#2A4035] py-20 md:py-32 px-6 overflow-hidden">
      {/* Background Pattern */}
